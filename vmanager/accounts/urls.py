...
urlpatterns = [
    ...
    path("change-password/", views.initial_password_change_view, name="initial_password_change"),
    path("settings/", views.settings_view, name="settings"),
    path("membership-status/", views.membership_status_view, name="membership_status"),
